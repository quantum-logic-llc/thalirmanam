...
const ContactSectionNew = () => {
    ...
    return (
        <section className="relative lg:py-24 py-16 overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="relative">
                                    <label htmlFor="message" className="block text-sm font-semibold mb-2 text-gray-700">
                                        Your Message<span className="text-orange-500 text-xs">(Message is required and must be at least 10 characters)</span> <span className="text-red-500">*</span>
                                    </label>
                                    <textarea
                                        name="message"
                                        id="message"
