        ...
        <section className="lg:pt-15 pt-10 lg:pb-15 pb-10 relative overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
            ...
            <div className="container relative z-10">
                ...
                <div className="text-center flex flex-col items-center mb-8 sm:mb-10 md:mb-12 px-3 sm:px-4">
                    <SlideUp>
                        <h2 className="text-[#f28cb3] text-2xl sm:text-[28px] md:text-[32px] font-bold uppercase mb-3 sm:mb-4">Our Focus Areas</h2>
                    </SlideUp>
                    <SlideUp delay={2}>
                    ...
                    <SlideUp delay={3}>
                        <p className="text-gray-600 text-sm sm:text-base md:text-lg mt-3 sm:mt-4 max-w-3xl mx-auto leading-relaxed">
                            Each focus area helps children take small, consistent steps (baby steps) that lead to meaningful growth
                        </p>
                    </SlideUp>
                </div>
    ...
    return (
        <SlideUp delay={id + 2}>
            <div className="border border-[#F2F2F2] bg-background rounded-lg sm:rounded-[10px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 h-full flex flex-col">
                {/* Image */}
                <div className="relative h-[220px] sm:h-[25
                0px] md:h-[250px] w-full overflow-hidden bg-gradient-to-br from-cream-foreground/40 to-green-foreground/5">
                    <Image
                        src={image}
                        alt={title}
                        fill
