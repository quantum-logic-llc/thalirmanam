    ...
    return (
        <div className="mt-5">
            ...
            <div className="mt-5 mb-6">
                <a href="" className="bg-primary text-cream-foreground rounded-md sm:flex hidden items-center gap-2.5  btn after:bg-green"> Book An Appointement <span><i className="fa-solid fa-arrow-right"></i></span> </a>
            </div>
